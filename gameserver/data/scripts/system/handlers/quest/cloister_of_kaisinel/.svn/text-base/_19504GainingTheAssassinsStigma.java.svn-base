...
public class _19504GainingTheAssassinsStigma extends QuestHandler
{
	private final static int	questId	= 19504;
	private final int			skillId = 1983;
	private final int			mainNpcId = 798501;

	public _19504GainingTheAssassinsStigma()
	{
		super(questId);
	}
