...
public class _11283RelicBundleRewardAncientIcon extends QuestHandler
{
	private final static int	questId	= 11283;
	private final static int	Items[][] =
	{{1011, 1352, 1693, 2034},
	{186000066, 186000065, 186000064, 186000063}};

	public _11283RelicBundleRewardAncientIcon()
	{
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		return defaultQuestRewardDialog(env, 799953, 0, var);
	}

	@Override
	public void register()
	{
		qe.setNpcQuestData(799953).addOnTalkEvent(questId);
	}
}
