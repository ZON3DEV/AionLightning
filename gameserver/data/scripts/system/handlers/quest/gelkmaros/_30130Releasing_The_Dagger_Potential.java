...
public class _30130Releasing_The_Dagger_Potential extends QuestHandler
{
    private final static int questId = 30130;
	
    public _30130Releasing_The_Dagger_Potential()
	{
        super(questId);
    }
            ...
            switch (targetId)
			{
                case 799336: //Tataka
                    switch (env.getDialogId())
					{
                        ...
                        case 34:
                            //Siel's Supreme Dagger (1)
                            //Noxallon Ingot (1)
                            if (QuestService.collectItemCheck(env, true))
	          {
                                player.getInventory().removeFromBagByItemId(100200810, 1); //Siel's Supreme Dagger
