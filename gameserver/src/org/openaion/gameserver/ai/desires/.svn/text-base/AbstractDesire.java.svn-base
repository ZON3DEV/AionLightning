 ...
 * @see org.openaion.gameserver.ai.desires.DesireQueue
...
public abstract class AbstractDesire implements Desire
{
	...
	/**
	 * Compares this desire with another, used by {@link org.openaion.gameserver.ai.desires.DesireQueue} to keep track of
	 * desire priorities.
	 * 
	 * @param o
