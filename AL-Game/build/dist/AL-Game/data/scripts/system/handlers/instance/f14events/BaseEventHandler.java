...
*/
    ...
    /**
     * Sends a system message to all players in the instance
     *
     * @param msg
     */
    ...
    /**
     * Sends a message to all players in the instance, message type <tt>Orange
     * text without boxing in the center</tt>
     *
     * @param msg
     */
    ...
    /**
     * Sends to the player in the instance, message type <tt>orange text without box
     * in the center </tt>
     *
     * @param msg
     */
    ...
    /**
     * Sends a message to all players in the instance, with the specified delay in
     * seconds, message type <tt>orange text without centered box</tt>
     *
     * @param sender
     * @param msg
     * @param delay
    ...
    /**
     * Sends to the player in the instance, with the specified delay in seconds, type
     * messages <tt>orange text without centered box</tt>
     *
     * @param sender
     * @param msg
     * @param delay
