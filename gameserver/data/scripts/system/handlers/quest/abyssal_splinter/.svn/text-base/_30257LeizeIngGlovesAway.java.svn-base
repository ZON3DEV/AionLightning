...
public class _30257LeizeIngGlovesAway extends QuestHandler
{
    private final static int questId = 30257;

    public _30257LeizeIngGlovesAway()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182209826, 1); //Aether Marble
