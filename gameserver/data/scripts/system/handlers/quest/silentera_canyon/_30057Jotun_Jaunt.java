...
public class _30057Jotun_Jaunt extends QuestHandler
{
	private final static int questId = 30057;
	
	public _30057Jotun_Jaunt()
	{
		super(questId);
	}
	...
	{
	    qe.setNpcQuestData(799381).addOnQuestStart(questId); //Lania
		qe.setNpcQuestData(799381).addOnTalkEvent(questId); //Lania
