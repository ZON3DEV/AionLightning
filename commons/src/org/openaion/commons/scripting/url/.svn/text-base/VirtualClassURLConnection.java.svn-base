package org.openaion.commons.scripting.url;
...
import org.openaion.commons.scripting.ScriptClassLoader;


/**
 * This class represents URL Connection that is used to "connect" to scripts binary data that was loaded by specified
 * {@link org.openaion.commons.scripting.impl.javacompiler.ScriptCompilerImpl}.<br>
 * <br>
