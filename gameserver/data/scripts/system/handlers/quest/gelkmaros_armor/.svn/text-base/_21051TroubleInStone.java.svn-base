...
public class _21051TroubleInStone extends QuestHandler
{
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182207839, 30);
    ...
    public void register()
	{
        ...
        qe.setNpcQuestData(799291).addOnQuestStart(questId); //Aquila
        qe.setNpcQuestData(799291).addOnTalkEvent(questId); //Aquila
    }
}