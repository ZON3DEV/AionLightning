 ...
 */
package org.openaion.gameserver.utils.rates;
...
public class PremiumRates extends Rates
{
	...
	/* (non-Javadoc)
	 * @see org.openaion.gameserver.utils.rates.Rates#getCraftingXPRate()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.openaion.gameserver.utils.rates.Rates#getGatheringXPRate()
	 */
	@Override
