...
public class _30259LeizesLegs extends QuestHandler
{
    private final static int questId = 30259;
	
    public _30259LeizesLegs()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182209828, 1);
