 ...
 * 
 */
public class _19014ArmorsmithsPotential extends QuestHandler
{
	private final static int	questId	= 19014;
	private final static int	questStartNpc = 203790;
	private final static int	secondNpc = 203791;
	private final static int[]	recipesItemIds = {152201806, 152201807};
	private final static int[]	recipesIds = {155001844, 155001845};

	public _19014ArmorsmithsPotential()
	{
		super(questId);
	}
