...
public class _21283RelicBundleRewardAncientGoblet extends QuestHandler
{
	private final static int	questId	= 21283;
	private final static int	Items[][] =
	{{1011, 1352, 1693, 2034},
	{186000058, 186000057, 186000056, 186000055}};

	public _21283RelicBundleRewardAncientGoblet()
	{
		super(questId);
	}
