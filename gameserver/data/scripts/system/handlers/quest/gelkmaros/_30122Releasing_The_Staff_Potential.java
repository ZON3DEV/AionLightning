...
public class _30122Releasing_The_Staff_Potential extends QuestHandler
{
    private final static int questId = 30122;
	
    public _30122Releasing_The_Staff_Potential()
	{
        super(questId);
    }
            ...
            switch (targetId)
			{
                case 799336: //Tataka
                    switch (env.getDialogId())
					{
                        ...
                        case 34:
                            //Siel's Supreme Staff (1)
                            //Noxallon Ingot (1)
                            if (QuestService.collectItemCheck(env, true))
	          {
                                player.getInventory().removeFromBagByItemId(101500701, 1); //Siel's Supreme Staff
