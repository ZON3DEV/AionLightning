	...
	private void startInvincibleTask() {
		...
		ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
				...
				PacketSendUtility.broadcastPacketAndReceive(getOwner(), new SM_FORCED_MOVE(getOwner(), getOwner()));
				spawn(284383, 284.50403f, 262.8162f, 248.77342f, (byte) 63); // clone
																				// skill
				spawn(284384, 271.2224f, 230.51619f, 250.94952f, (byte) 36); // clone
																				// classic
				spawn(284384, 240.22404f, 235.21863f, 251.1519f, (byte) 20); // clone
																				// classic
				spawn(284384, 232.55373f, 263.82864f, 248.65227f, (byte) 115); // clone
																				// classic
				spawn(284384, 255.52051f, 293.178f, 253.8094f, (byte) 90); // clone
																			// classic
			}
		}, 2000);
	}
