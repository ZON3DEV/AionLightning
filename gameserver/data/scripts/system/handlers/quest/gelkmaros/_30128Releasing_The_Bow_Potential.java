...
public class _30128Releasing_The_Bow_Potential extends QuestHandler
{
    private final static int questId = 30128;
	
    public _30128Releasing_The_Bow_Potential()
	{
        super(questId);
    }
            ...
            switch (targetId)
			{
                case 799336: //Tataka
                    switch (env.getDialogId())
					{
                        ...
                        case 34:
                            //Siel's Supreme Bow (1)
                            //Noxallon Ingot (1)
                            if (QuestService.collectItemCheck(env, true))
	          {
                                player.getInventory().removeFromBagByItemId(101700725, 1); //Siel's Supreme Bow
