 ...
 * 
 */
public class _19026HandicraftersPotential extends QuestHandler
{
	private final static int	questId	= 19026;
	private final static int	questStartNpc = 203792;
	private final static int	secondNpc = 798013;
	private final static int[]	recipesItemIds = {152202049, 152202050};
	private final static int[]	recipesIds = {155002087, 155002088};

	public _19026HandicraftersPotential()
	{
		super(questId);
	}
				...
				case secondNpc:
					switch(env.getDialogId())
					{
						...
						case 10009:
							...
							{
								defaultQuestGiveItem(env, 152020249, 1);
