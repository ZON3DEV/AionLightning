...
public class EmpyreanCrucibleInstance extends CrucibleInstance {
	...
	public void onEnterInstance(Player player) {
		...
		if (isNew && stage > 0) {
			moveToReadyRoom(player); // send player to team and wait for end of
										// the stage
	...
	public void onDie(Npc npc) {
		...
		switch (npc.getNpcId()) {
			...
			case 217578:
				...
				// sp(217583, 1794.81f, 779.53925f, 469.35016f, (byte) 40,
				// 6000);
				break;
			case 217579:
			case 217583:
				...
				// sp(217584, 1775.6254f, 811.43225f, 469.35022f, (byte) 100,
				// 6000);
				break;
			case 217580:
			case 217584:
	...
	public void onChangeStage(final StageType type) {
		switch (type) {
			...
			case START_STAGE_7_ROUND_1:
				...
				// sp(217582, 1794.908f, 811.9936f, 469.3501f, (byte) 80, 6000);
				// //asmo, need sniff
				break;
			...
			case START_STAGE_8:
				...
				teleport(1776.4169f, 1749.9952f, 303.69553f, (byte) 0); // get
																		// retail
				sendEventPacket(type, 1000);
				break;
			case START_STAGE_9:
	...
	private void moveToReadyRoom(Player player) {
		switch (stage) {
			...
			case 7:
				...
				break;
			case 8:
				teleport(player, 1780.103f, 1723.458f, 304.039f, (byte) 53); // get
																				// retail
				break;
			case 9:
