...
public class _30260RosareasHeart extends QuestHandler
{
    private final static int questId = 30260;

    public _30260RosareasHeart()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182209829, 1);
