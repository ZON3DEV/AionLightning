...
public class _4967NinissSecondCharm extends QuestHandler
{
	private final static int	questId	= 4967;
	private final static int[]	npcs = {798385, 798068};
	
	public _4967NinissSecondCharm()
	{
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		if(defaultQuestNoneDialog(env, 798385, 182207137, 1))
			return true;
			...
			switch (env.getTargetId())
			{
				case 798068:
					switch(env.getDialogId())
					{
						...
						case 10000:
							return defaultCloseDialog(env, 0, 1, 0, 0, 182207137, 1);
					}
					break;
				case 798385:
					switch(env.getDialogId())
