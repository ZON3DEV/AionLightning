...
public class _30263DaevasFearToTread extends QuestHandler
{
	...
	private final static int[]	npcs = {278651, 207945};
	...
	{
		qe.setNpcQuestData(278651).addOnQuestStart(questId);
		for(int npc: npcs)
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		if(defaultQuestNoneDialog(env, 278651, 4762, 182209801, 1))
			return true;
		...
		return defaultQuestRewardDialog(env, 278651, 10002);
	}
}
