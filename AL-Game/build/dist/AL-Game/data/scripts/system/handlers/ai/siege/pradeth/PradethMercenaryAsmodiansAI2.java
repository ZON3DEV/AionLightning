	...
	public boolean onDialogSelect(Player player, int dialogId, int questId, int extendedRewardIndex) {
		switch (DialogAction.getActionByDialogId(dialogId)) {
			...
			case SETPRO2:
				...
				break;
			case SETPRO3:
                spawn(273316, 2596.982f, 2737.708f, 266.19125f, (byte) 46); // Empty Etched Bombard
                spawn(273316, 2611.173f, 2752.241f, 266.19125f, (byte) 45); // Empty Etched Bombard
                spawn(273316, 2705.3672f, 2636.0967f, 266.20126f, (byte) 106); // Empty Etched Bombard
                spawn(273316, 2718.9968f, 2651.4675f, 266.20126f, (byte) 105); // Empty Etched Bombard
                break;
			default:
				break;
		}
