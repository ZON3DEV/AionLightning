...
public class _1471FakeStigma extends QuestHandler
{
	...
	{
		qe.setNpcQuestData(203991).addOnQuestStart(questId); //Dionera
		qe.setNpcQuestData(203991).addOnTalkEvent(questId); //Dionera
		qe.setNpcQuestData(203703).addOnTalkEvent(questId); //Likesan
		qe.setNpcQuestData(798048).addOnTalkEvent(questId);//Kierunerk
		qe.setNpcQuestData(798024).addOnTalkEvent(questId); //Chicorinerk
	}
