...
public class _11284RelicBundleRewardAncientSeal extends QuestHandler
{
	private final static int	questId	= 11284;
	private final static int	Items[][] =
	{{1011, 1352, 1693, 2034},
	{186000062, 186000061, 186000060, 186000059}};

	public _11284RelicBundleRewardAncientSeal()
	{
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		return defaultQuestRewardDialog(env, 799954, 0, var);
	}

	@Override
	public void register()
	{
		qe.setNpcQuestData(799954).addOnTalkEvent(questId);
	}
}