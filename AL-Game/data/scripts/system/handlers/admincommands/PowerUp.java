...
public class PowerUp extends AdminCommand {
	...
	public void execute(Player admin, String... params) {
		...
		// player.getLifeStats().increaseHp(TYPE.HP,
		// admin.getLifeStats().getMaxHp() + 1);
		// player.getLifeStats().increaseMp(TYPE.MP,
		// admin.getLifeStats().getMaxMp() + 1);
		...
		// " made you normal again.");
		// }
		// return;
		// }
		// player.getGameStats().setStat(StatEnum.MAXMP,
		// admin.getLifeStats().getMaxHp() * index);
		// player.getGameStats().setStat(StatEnum.MAXHP,
		// admin.getLifeStats().getMaxMp() * index);
		//
		// player.getGameStats().setStat(StatEnum.BLOCK,
		// admin.getGameStats().getStatBonus(StatEnum.BLOCK) * index);
		// player.getGameStats().setStat(StatEnum.EVASION,
		// admin.getGameStats().getStatBonus(StatEnum.EVASION) * index);
		// player.getGameStats().setStat(StatEnum.HEALTH,
		// admin.getGameStats().getStatBonus(StatEnum.HEALTH) * index);
		// player.getGameStats().setStat(StatEnum.ACCURACY,
		// admin.getGameStats().getStatBonus(StatEnum.ACCURACY) * index);
		// player.getGameStats().setStat(StatEnum.PARRY,
		// admin.getGameStats().getStatBonus(StatEnum.PARRY) * index);
		//
		// player.getGameStats().setStat(StatEnum.MAIN_HAND_ACCURACY,
		// admin.getGameStats().getStatBonus(StatEnum.MAIN_HAND_ACCURACY) *
		// index);
		// player.getGameStats().setStat(StatEnum.MAIN_HAND_CRITICAL,
		// admin.getGameStats().getStatBonus(StatEnum.MAIN_HAND_CRITICAL) *
		// index);
		...
		// admin.getGameStats().getStatBonus(StatEnum.OFF_HAND_ACCURACY) *
		// index);
		// player.getGameStats().setStat(StatEnum.OFF_HAND_CRITICAL,
		// admin.getGameStats().getStatBonus(StatEnum.OFF_HAND_CRITICAL) *
		// index);
		...
		// admin.getGameStats().getStatBonus(StatEnum.OFF_HAND_ATTACK_SPEED) *
		// index);
		//
		...
		// admin.getGameStats().getStatBonus(StatEnum.MAGICAL_ACCURACY) *
		// index);
		// player.getGameStats().setStat(StatEnum.MAGICAL_CRITICAL,
		// admin.getGameStats().getStatBonus(StatEnum.MAGICAL_CRITICAL) *
		// index);
		...
		// admin.getGameStats().getStatBonus(StatEnum.BOOST_MAGICAL_SKILL) *
		// index * 15);
		//
		// player.getGameStats().setStat(StatEnum.REGEN_MP,
		// admin.getGameStats().getStatBonus(StatEnum.REGEN_MP) * index);
		// player.getGameStats().setStat(StatEnum.REGEN_HP,
		// admin.getGameStats().getStatBonus(StatEnum.REGEN_HP) * index);
		//
		// player.getLifeStats().increaseHp(TYPE.HP,
		// admin.getLifeStats().getMaxHp() + 1);
		// player.getLifeStats().increaseMp(TYPE.MP,
		...
		// PacketSendUtility.sendPacket(player, new SM_STATS_INFO(admin));
		// if (player == admin)
		// PacketSendUtility.sendMessage(player, "You are now " + index +
