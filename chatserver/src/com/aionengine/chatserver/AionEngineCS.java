...
public class AionEngineCS
{
	...
	public static void infoCS()
	{
		...
		_log.info("  ###     ### ###########  ########  ###    ####  ");
		_log.info("                                                  ");
		_log.info("                   E X T R E M E                  ");
		_log.info("                                                  ");
		_log.info("        Project Owner:Dallas                      ");
		_log.info("        Community Manager:                        ");
		_log.info("        Developers:                               ");
		_log.info("                                                  ");
		_log.info("                                                  ");
		_log.info("                                                  ");
		_log.info("                                                  ");
