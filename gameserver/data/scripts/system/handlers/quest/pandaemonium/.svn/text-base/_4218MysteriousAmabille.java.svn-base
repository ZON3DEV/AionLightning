...
public class _4218MysteriousAmabille extends QuestHandler
{
	...
	private final static int[]	npcs = {204284, 798334};
	...
	{
		qe.setNpcQuestData(204284).addOnQuestStart(questId);
		for(int npc: npcs)
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		if(defaultQuestNoneDialog(env, 204284, 182209111, 1))
			return true;
