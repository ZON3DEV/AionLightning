...
public class _29507GainingTheSpiritmastersStigma extends QuestHandler
{
	private final static int	questId	= 29507;
	private final int			skillId = 2011;
	private final int			mainNpcId = 204056;

	public _29507GainingTheSpiritmastersStigma()
	{
		super(questId);
	}
