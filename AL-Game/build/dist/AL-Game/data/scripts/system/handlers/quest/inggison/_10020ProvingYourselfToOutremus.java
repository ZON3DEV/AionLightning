						...
						case USE_OBJECT: {
							if (var == 2 && var1 == 0) {
								if (var2 == 1 && var3 == 1) {
									...
									changeQuestStep(env, 0, 1, false, 1); // 1:
																			// 1
									return true;
								}
							}
						...
						case USE_OBJECT: {
							if (var == 2 && var2 == 0) {
								if (var1 == 1 && var3 == 1) {
									...
									changeQuestStep(env, 0, 1, false, 2); // 2:
																			// 1
									return true;
								}
							}
						...
						case USE_OBJECT: {
							if (var == 2 && var3 == 0) {
								if (var2 == 1 && var1 == 1) {
									...
									changeQuestStep(env, 0, 1, false, 3); // 3:
																			// 1
									return true;
								}
							}
		...
		if (qs.getStatus() == QuestStatus.START) {
			if (var == 3) {
				...
				if (targetId == spellers[0] || targetId == spellers[1]) {
					if (var2 < 2) {
						return defaultOnKillEvent(env, spellers, var2, var2 + 1, 2); // 2:
																						// 1
																						// -
																						// 3
					} else if (var2 == 2) {
