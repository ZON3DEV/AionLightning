				...
				switch (env.getDialog()) {
					...
					case CHECK_USER_HAS_QUEST_ITEM: {
						...
						if (collect1 >= 2 && collect2 >= 5) {
							...
							return sendQuestDialog(env, 1352); // choose your
																// reward
						} else {
					...
					case SETPRO10: {
						rewardGroup = 0;
						return defaultCloseDialog(env, var, var, true, true, 0); // reward
																					// 1
					}
					case SETPRO20: {
						rewardGroup = 1;
						return defaultCloseDialog(env, var, var, true, true, 1); // reward
																					// 2
					}
					case SETPRO30: {
						rewardGroup = 2;
						return defaultCloseDialog(env, var, var, true, true, 2); // reward
																					// 3
					}
					default:
						break;
