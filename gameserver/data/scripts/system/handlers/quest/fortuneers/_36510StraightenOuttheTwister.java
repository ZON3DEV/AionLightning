...
{
	private final static int	questId	= 36510;
	...
	public void QuestUseNpcInsideFunction(QuestCookie env)
	{
		...
		{
			Npc trap = (Npc)vO;
			if(trap.getNpcId() == 700761)
				QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 216614, trap.getX(), trap.getY(), trap.getZ(), (byte) 0, true);
		}
	}
