...
public class _4970TheFashionistas extends QuestHandler
{
	...
	private final static int[]	npcs = {798315, 798392, 798393};
	...
	{
		qe.setNpcQuestData(798315).addOnQuestStart(questId);
		for(int npc: npcs)
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		if(defaultQuestNoneDialog(env, 798315))
			return true;
