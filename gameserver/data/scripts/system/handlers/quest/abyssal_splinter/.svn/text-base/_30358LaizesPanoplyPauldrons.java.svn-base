...
public class _30358LaizesPanoplyPauldrons extends QuestHandler
{
    private final static int questId = 30358;
	
    public _30358LaizesPanoplyPauldrons()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182209832, 1);
