...
public class TribeRelationsData {
	...
	public boolean isSupportRelation(TribeClass tribeName1, TribeClass tribeName2) {
		...
		return tribe1.getSupport().contains(tribe2.getBase()) || tribe1.getSupport().contains(tribeName2) || tribe2.getSupport().contains(tribe1.getBase())
				|| tribe2.getSupport().contains(tribeName1);
	}
	...
	public boolean isNeutralRelation(TribeClass tribeName1, TribeClass tribeName2) {
		...
		return tribe1.getNeutral().contains(tribe2.getBase()) || tribe1.getNeutral().contains(tribeName2) || tribe2.getNeutral().contains(tribe1.getBase())
				|| tribe2.getNeutral().contains(tribeName1);
	}
	...
	public boolean isHostileRelation(TribeClass tribeName1, TribeClass tribeName2) {
		...
		return tribe1.getHostile().contains(tribe2.getBase()) || tribe1.getHostile().contains(tribeName2) || tribe2.getHostile().contains(tribe1.getBase())
				|| tribe2.getHostile().contains(tribeName1);
	}
