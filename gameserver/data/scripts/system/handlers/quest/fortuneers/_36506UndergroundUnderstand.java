...
public class _36506UndergroundUnderstand extends QuestHandler
{
	private final static int	questId	= 36506;

	public _36506UndergroundUnderstand()
	{
		super(questId);
	}
	...
	{
		return defaultQuestOnKillEvent(env, 216610, 0, true);
	}
	...
	public void register()
	{
		...
		qe.setNpcQuestData(216610).addOnKillEvent(questId);
	}
}
