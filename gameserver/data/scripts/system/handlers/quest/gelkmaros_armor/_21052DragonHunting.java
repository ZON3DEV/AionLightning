...
public class _21052DragonHunting extends QuestHandler
{
    private final static int questId = 21052;
	
    public _21052DragonHunting()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182207840, 30);
    ...
    public void register()
	{
        ...
        qe.setNpcQuestData(799268).addOnQuestStart(questId); //Nysdvor
        qe.setNpcQuestData(799268).addOnTalkEvent(questId); //Nysdvor
    }
}