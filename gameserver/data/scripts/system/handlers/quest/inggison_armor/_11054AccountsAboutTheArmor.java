...
public class _11054AccountsAboutTheArmor extends QuestHandler
{
    private final static int questId = 11054;
	
    public _11054AccountsAboutTheArmor()
	{
        super(questId);
    }
    ...
    public void register()
	{
        ...
        qe.setNpcQuestData(799017).addOnQuestStart(questId); //Sulinia
        qe.setNpcQuestData(799017).addOnTalkEvent(questId); //Sulinia
    }
}