...
public class English extends Language {
	...
	public English() {
		 ...
		 */
		addTranslatedMessage(CustomMessageId.Event_Util_1, "You can not use this command.");
		addTranslatedMessage(CustomMessageId.Event_Util_2, "Wrong Event Type.");
		addTranslatedMessage(CustomMessageId.Event_Util_3, "Unknown User.");
			
        /**
        * EventEngine - Event
        */
        addTranslatedMessage(CustomMessageId.Event_1, "You can not participate in the event, while you are in prison, or during the fight.");	
	}
}