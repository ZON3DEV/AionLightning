...
public class German extends Language {
	...
	public German() {
		...
		addTranslatedMessage(CustomMessageId.COMMAND_SEND_MAPPING_NOT_FOUND, "%s nicht gefunden");
		...
		* Go Command (PvP Command)
		 ...
		 */
		addTranslatedMessage(CustomMessageId.Event_Util_1, "Du kannst diesen Befehl nicht verwenden.");
		addTranslatedMessage(CustomMessageId.Event_Util_2, "Falsche Event Typ.");
		addTranslatedMessage(CustomMessageId.Event_Util_3, "Unbekannter Benutzer.");
			
        /**
        * EventEngine - Event
        */
        addTranslatedMessage(CustomMessageId.Event_1, "Du kannst an diesem Event nicht teilnehmen, waehrend du im Gefaengnis bist, oder in Kampfzustand.");	
	}
}