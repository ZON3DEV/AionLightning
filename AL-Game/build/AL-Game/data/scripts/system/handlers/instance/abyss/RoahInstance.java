...
public class RoahInstance extends GeneralInstanceHandler {
	...
	private void spawnRings() {
		FlyRing f1 = new FlyRing(new FlyRingTemplate("ROAH_WING_1", mapId, new Point3D(501.77, 409.53, 94.12), new Point3D(503.93, 409.65, 98.9), new Point3D(
				506.26, 409.7, 94.15), 10), instanceId);
		f1.spawn();
	}
