...
public final class BufferUtils {
	 ...
	 */
	/*
	 * public static void setInBuffer(ColorRGBA color, FloatBuffer buf, int
	 * index) { buf.position(index*4); buf.put(color.r); buf.put(color.g);
	 * buf.put(color.b); buf.put(color.a); }
	 */
	/**
	...
	public static void printCurrentDirectMemory(StringBuilder store) {
		...
		store.append("(b: ").append(bBufs).append("  f: ").append(fBufs).append("  i: ").append(iBufs).append("  s: ").append(sBufs).append("  d: ")
				.append(dBufs).append(")").append("\n");
		store.append("Total   heap memory held: ").append(heapMem / 1024).append("kb\n");
		store.append("Total direct memory held: ").append(totalHeld / 1024).append("kb\n");
		store.append("(b: ").append(bBufsM / 1024).append("kb  f: ").append(fBufsM / 1024).append("kb  i: ").append(iBufsM / 1024).append("kb  s: ")
				.append(sBufsM / 1024).append("kb  d: ").append(dBufsM / 1024).append("kb)").append("\n");
		if (printStout) {
