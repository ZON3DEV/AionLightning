...
public class _21039Beaks_and_Beakers extends QuestHandler
{
    private final static int questId = 21039;

    public _21039Beaks_and_Beakers()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182207833, 50);
	...
	{
        qe.setNpcQuestData(799213).addOnQuestStart(questId); //Nordin
        qe.setNpcQuestData(799213).addOnTalkEvent(questId); //Nordin
    }
}