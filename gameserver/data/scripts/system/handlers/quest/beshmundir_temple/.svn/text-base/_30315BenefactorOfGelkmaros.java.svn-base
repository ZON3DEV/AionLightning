...
public class _30315BenefactorOfGelkmaros extends QuestHandler
{
    private final static int questId = 30315;

    public _30315BenefactorOfGelkmaros()
	{
        super(questId);
    }
	...
	{
        qe.setNpcQuestData(799226).addOnQuestStart(questId); //Valetta
        qe.setNpcQuestData(799226).addOnTalkEvent(questId); //Valetta
    }
}