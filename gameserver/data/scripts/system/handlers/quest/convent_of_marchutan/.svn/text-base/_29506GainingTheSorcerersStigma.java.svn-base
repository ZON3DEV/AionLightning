...
public class _29506GainingTheSorcerersStigma extends QuestHandler
{
	private final static int	questId	= 29506;
	private final int			skillId = 1434;
	private final int			mainNpcId = 204056;

	public _29506GainingTheSorcerersStigma()
	{
		super(questId);
	}
