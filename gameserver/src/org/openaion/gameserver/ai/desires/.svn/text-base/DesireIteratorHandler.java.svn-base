 ...
 * @see org.openaion.gameserver.ai.desires.DesireQueue#iterateDesires(DesireIteratorHandler, DesireIteratorFilter[])
 */
public interface DesireIteratorHandler
{
	 ...
	 * {@link org.openaion.gameserver.ai.desires.DesireQueue#iterateDesires(DesireIteratorHandler, DesireIteratorFilter[])}
	 * if any of the following methods will be called from here:
	 * <ul>
	 * <li>{@link org.openaion.gameserver.ai.desires.DesireQueue#addDesire(Desire)}</li>
	 * <li>{@link org.openaion.gameserver.ai.desires.DesireQueue#poll()}</li>
	 * <li>{@link org.openaion.gameserver.ai.desires.DesireQueue#removeDesire(Desire)}</li>
	 * </ul>
	 * <p/>
	 * However {@link org.openaion.gameserver.ai.desires.DesireQueue#clear()} can be called.
	 * 
	 * @param desire
