 ...
 * 
 */
public class _29032AlchemistsPotential extends QuestHandler
{
	private final static int	questId	= 29032;
	private final static int	questStartNpc = 204102;
	private final static int	secondNpc = 204103;
	private final static int[]	recipesItemIds = {152207149, 152207150};
	private final static int[]	recipesIds = {155007187, 155007188};

	public _29032AlchemistsPotential()
	{
		super(questId);
	}
				...
				case secondNpc:
					switch(env.getDialogId())
					{
						...
						case 10009:
							...
							{
								defaultQuestGiveItem(env, 152029249, 1);
