...
public class TalocsHollowInstance extends GeneralInstanceHandler {
	...
	private void addItems(Player player) {
		...
		if ((qs1 != null && qs1.getStatus() == QuestStatus.START) || (qs2 != null && qs2.getStatus() == QuestStatus.START)
				|| (qs2 != null && qs3.getStatus() == QuestStatus.START) || (qs4 != null && qs4.getStatus() == QuestStatus.START)) {
			return;
		}
	...
	private void spawnRings() {
		...
		f1.spawn();
		FlyRing f2 = new FlyRing(new FlyRingTemplate("TALOCS_2", mapId, new Point3D(592.32275, 844.056, 1295.0966), new Point3D(592.32275, 844.056, 1301.0966),
