...
public class _11052GlovesAndGlossyBeads extends QuestHandler
{
    private final static int questId = 11052;
	
    public _11052GlovesAndGlossyBeads()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182206837, 30);
    ...
    public void register()
	{
        ...
        qe.setNpcQuestData(798984).addOnQuestStart(questId); //Meininerk
        qe.setNpcQuestData(798984).addOnTalkEvent(questId); //Meininerk
    }
}