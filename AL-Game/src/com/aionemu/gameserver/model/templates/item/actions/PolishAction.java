...
public class PolishAction extends AbstractItemAction {
    ...
    @XmlAttribute(name = "polish_id")
    protected Integer polishId;
    ...
    public boolean canAct(Player player, Item parentItem, Item targetItem) {
      ...
      /*if (targetItem.hasTune()) {
        ...
        return !player.isAttackMode() && targetItem.getItemTemplate().isWeapon() && targetItem.getItemTemplate().isCanPolish() && polishId != null;
    }
    ...
    public void act(final Player player, final Item parentItem, final Item targetItem) {
        ...
        player.getController().addTask(TaskId.ITEM_USE, ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                RandomBonusResult bonus = DataManager.ITEM_RANDOM_BONUSES.getRandomModifiers(StatBonusType.POLISH, polishId);
                if (bonus == null) {
