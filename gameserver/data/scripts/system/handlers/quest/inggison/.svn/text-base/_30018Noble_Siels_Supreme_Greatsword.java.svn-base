...
public class _30018Noble_Siels_Supreme_Greatsword extends QuestHandler
{
    private final static int questId = 30018;

    public _30018Noble_Siels_Supreme_Greatsword()
	{
        super(questId);
    }
