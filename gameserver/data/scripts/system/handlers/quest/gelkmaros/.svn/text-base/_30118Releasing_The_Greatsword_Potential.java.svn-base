...
public class _30118Releasing_The_Greatsword_Potential extends QuestHandler
{
    private final static int questId = 30118;
	
    public _30118Releasing_The_Greatsword_Potential()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(100900687, 1); //Siel's Supreme Greatsword
