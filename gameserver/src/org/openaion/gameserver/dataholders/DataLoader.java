...
abstract class DataLoader
{
	 ...
	 *            Every read row is then forwarded to {@link #parse(String)} method, which should be overriden in
	 *            subclcass.
	 */
	...
	/**
	 * This method must be overriden in subclass which we want to be able to save data. It's responsibility is basicly
	 * to put data into given FileWriter instance.
	 * 
	 * @param fileWriter
	 * @throws Exception
	 */
