...
public class _1042KeeperoftheKaidanKey extends QuestHandler
{
	...
	@Override
	public HandlerResult onItemUseEvent(QuestCookie env, Item item) // quest can be completed by using the needed key if it was gained before this fix
	{
