...
public class _11285RelicBundleRewardAncientGoblet extends QuestHandler
{
	private final static int	questId	= 11285;
	private final static int	Items[][] =
	{{1011, 1352, 1693, 2034},
	{186000058, 186000057, 186000056, 186000055}};

	public _11285RelicBundleRewardAncientGoblet()
	{
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		return defaultQuestRewardDialog(env, 799955, 0, var);
	}

	@Override
	public void register()
	{
		qe.setNpcQuestData(799955).addOnTalkEvent(questId);
	}
}