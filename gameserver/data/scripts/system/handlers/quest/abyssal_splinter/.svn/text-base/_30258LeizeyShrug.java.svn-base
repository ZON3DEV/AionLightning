...
public class _30258LeizeyShrug extends QuestHandler
{
    private final static int questId = 30258;
	
    public _30258LeizeyShrug()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182209827, 1); //Aether Marble
