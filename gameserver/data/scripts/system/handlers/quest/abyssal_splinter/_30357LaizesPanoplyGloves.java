...
public class _30357LaizesPanoplyGloves extends QuestHandler
{
    private final static int questId = 30357;
	
    public _30357LaizesPanoplyGloves()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182209831, 1);
