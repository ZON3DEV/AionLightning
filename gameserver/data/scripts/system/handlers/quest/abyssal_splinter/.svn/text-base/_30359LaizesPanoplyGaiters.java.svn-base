...
public class _30359LaizesPanoplyGaiters extends QuestHandler
{
    private final static int questId = 30359;
	
    public _30359LaizesPanoplyGaiters()
	{
        super(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env)
	{
        ...
        if (qs.getStatus() == QuestStatus.START)
		{
            switch (targetId)
			{
	          ...
	          {
                                player.getInventory().removeFromBagByItemId(182209833, 1); //Crystal Fragment
