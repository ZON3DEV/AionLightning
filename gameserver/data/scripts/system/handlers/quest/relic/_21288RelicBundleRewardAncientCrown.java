...
public class _21288RelicBundleRewardAncientCrown extends QuestHandler
{
	private final static int	questId	= 21288;
	private final static int	Items[][] =
	{{1011, 1352, 1693, 2034},
	{186000054, 186000053, 186000052, 186000051}};

	public _21288RelicBundleRewardAncientCrown()
	{
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		return defaultQuestRewardDialog(env, 799960, 0, var);
	}

	@Override
	public void register()
	{
		qe.setNpcQuestData(799960).addOnTalkEvent(questId);
	}
}
