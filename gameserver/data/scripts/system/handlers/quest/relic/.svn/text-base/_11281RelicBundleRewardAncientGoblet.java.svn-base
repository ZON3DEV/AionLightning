...
public class _11281RelicBundleRewardAncientGoblet extends QuestHandler
{
	private final static int	questId	= 11281;
	private final static int	Items[][] =
	{{1011, 1352, 1693, 2034},
	{186000058, 186000057, 186000056, 186000055}};

	public _11281RelicBundleRewardAncientGoblet()
	{
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		return defaultQuestRewardDialog(env, 278146, 0, var);
	}
