			...
			if (var == 2) {
				...
				switch (targetId) {
					...
					case 216033: { // Naduka Wardrake
						if (var1 < 4) {
							return defaultOnKillEvent(env, nadukas, 0, 4, 1); // 1:
																				// 0
																				// -
																				// 9
						} else if (var1 == 4) {
							if (var2 == 10) {
								...
								return defaultOnKillEvent(env, nadukas, 4, 5, 1); // 1:
																					// 10
							}
						}
						break;
					...
					case 216101: { // Balaur of Vorgaltem Battlefield
						if (var2 < 9) {
							return defaultOnKillEvent(env, balaurs, 0, 9, 2); // 2:
																				// 0
																				// -
																				// 29
						} else if (var2 == 9) {
							if (var1 == 5) {
								...
								return defaultOnKillEvent(env, balaurs, 9, 10, 2); // 2:
																					// 30
							}
						}
						break;
