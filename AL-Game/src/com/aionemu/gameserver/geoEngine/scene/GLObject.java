...
public abstract class GLObject implements Cloneable {
	...
	/**
	 * The ID of the object, usually depends on its type. Typically returned
	 * from calls like glGenTextures, glGenBuffers, etc.
	 */
	protected int id = -1;
	/**
	...
	/**
	 * True if the data represented by this GLObject has been changed and needs
	 * to be updated before used.
	 */
	...
	public static enum Type {
		...
		/**
		 * Vertex buffers are used to describe geometry data and it's
		 * attributes.
		 */
		VertexBuffer,
		/**
		 * ShaderSource is a shader source code that controls the output of a
		 * certain rendering pipeline, like vertex position or fragment color.
		 */
		ShaderSource,
		/**
		 * A Shader is an aggregation of ShaderSources, collectively they
		 * cooperate to control the vertex and fragment processor.
		 */
		Shader,
	}
	...
	/**
	 * Creates a shallow clone of this GL Object. The deleteObject method should
	 * be functional for this object.
	 */
