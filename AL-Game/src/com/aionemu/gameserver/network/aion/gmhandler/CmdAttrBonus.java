...
public class CmdAttrBonus extends AbstractGMHandler implements StatOwner {
	...
	enum AttrBonusAction {
		...
		AGI("AGI", StatEnum.ACCURACY), AGIDEX("AGIDEX", StatEnum.AGIDEX), ALLPARA("ALLPARA", StatEnum.ALLRESIST), ARALL("ARALL",
				StatEnum.ABNORMAL_RESISTANCE_ALL), ARBLEED("ARBLEED", StatEnum.BLEED_RESISTANCE), ARBLIND("ARBLIND", StatEnum.BLIND_RESISTANCE), ARCHARM(
				"ARCHARM", StatEnum.CHARM_RESISTANCE), ARCONFUSE("ARCONFUSE", StatEnum.CONFUSE_RESISTANCE), ARDISEASE("ARDISEASE", StatEnum.DISEASE_RESISTANCE), ARFEAR(
				"ARFEAR", StatEnum.FEAR_RESISTANCE), AROPENAREIAL("AROPENAREIAL", StatEnum.OPENAREIAL_RESISTANCE), ARPARALYZE("ARPARALYZE",
				StatEnum.PARALYZE_RESISTANCE), ARPERIFICATION("ARPERIFICATION", StatEnum.PERIFICATION_RESISTANCE), ARPOISON("ARPOISON",
				StatEnum.POISON_RESISTANCE), ARROOT("ARROOT", StatEnum.ROOT_RESISTANCE), ARSILENCE("ARSILENCE", StatEnum.SILENCE_RESISTANCE), ARSLEEP(
				"ARSLEEP", StatEnum.SLEEP_RESISTANCE), ARSLOW("ARSLOW", StatEnum.SLOW_RESISTANCE), ARSNARE("ARSNARE", StatEnum.SNARE_RESISTANCE), ARSPIN(
				"ARSPIN", StatEnum.SPIN_RESISTANCE), ARSTAGGER("ARSTAGGER", StatEnum.STAGGER_RESISTANCE), ARSTUMBLE("ARSTUMBLE", StatEnum.STUMBLE_RESISTANCE), ARSTUN(
				"ARSTUN", StatEnum.STUN_RESISTANCE), ATTACKDELAY("ATTACKDELAY", StatEnum.ATTACK_SPEED), ATTACKRANGE("ATTACKRANGE", StatEnum.ATTACK_RANGE), BLEED_ARP(
				"BLEED ARP", StatEnum.BLEED_RESISTANCE_PENETRATION), BLIND_ARP("BLIND ARP", StatEnum.BLIND_RESISTANCE_PENETRATION), BLOCK("BLOCK",
				StatEnum.BLOCK), BOOSTCASTINGTIME("BOOSTCASTINGTIME", StatEnum.BOOST_CASTING_TIME), CHARM_ARP("CHARM ARP",
				StatEnum.CHARM_RESISTANCE_PENETRATION), CONCENTRATION("CONCENTRATION", StatEnum.CONCENTRATION), CONFUSE_ARP("CONFUSE ARP",
				StatEnum.CONFUSE_RESISTANCE_PENETRATION), CRITICAL("CRITICAL", StatEnum.PHYSICAL_CRITICAL), CURSE_ARP("CURSE ARP",
				StatEnum.CURSE_RESISTANCE_PENETRATION), DEX("DEX", StatEnum.AGILITY), DISEASE_ARP("DISEASE ARP", StatEnum.DISEASE_RESISTANCE_PENETRATION), DODGE(
				"DODGE", StatEnum.EVASION), ELEMENTALDEFENDAIR("ELEMENTALDEFENDAIR", StatEnum.WIND_RESISTANCE), ELEMENTALDEFENDEARTH("ELEMENTALDEFENDEARTH",
				StatEnum.EARTH_RESISTANCE), ELEMENTALDEFENDFIRE("ELEMENTALDEFENDFIRE", StatEnum.FIRE_RESISTANCE), ELEMENTALDEFENDWATER("ELEMENTALDEFENDWATER",
				StatEnum.WATER_RESISTANCE), FEAR_ARP("FEAR ARP", StatEnum.FEAR_RESISTANCE_PENETRATION), FLYSPEED("FLYSPEED", StatEnum.FLY_SPEED), FPREGEN(
				"FPREGEN", StatEnum.REGEN_FP), HEALSKILLBOOST("HEALSKILLBOOST", StatEnum.HEAL_BOOST), HITCOUNT("HITCOUNT", StatEnum.HIT_COUNT), HP("HP",
				StatEnum.MAXHP), HPREGEN("HPREGEN", StatEnum.REGEN_HP), KNO("KNO", StatEnum.KNOWLEDGE), KNOWIL("KNOWIL", StatEnum.KNOWIL), MAGICALATTACK(
				"MAGICALATTACK", StatEnum.MAGICAL_ATTACK), MAGICALCRITICALDAMAGEREDUCE("MAGICALCRITICALDAMAGEREDUCE", StatEnum.MAGICAL_CRITICAL_DAMAGE_REDUCE), MAGICALCRITICAL(
				"MAGICALCRITICAL", StatEnum.MAGICAL_CRITICAL), MAGICALCRITICALREDUCERATE("MAGICALCRITICALREDUCERATE", StatEnum.MAGICAL_CRITICAL_RESIST), MAGICALDEFEND(
				"MAGICALDEFEND", StatEnum.MAGICAL_DEFEND), MAGICALHITACCURACY("MAGICALHITACCURACY", StatEnum.MAGICAL_ACCURACY), MAGICALRESIST("MAGICALRESIST",
				StatEnum.MAGICAL_RESIST), MAGICALSKILLBOOST("MAGICALSKILLBOOST", StatEnum.BOOST_MAGICAL_SKILL), MAGICALSKILLBOOSTRESIST(
				"MAGICALSKILLBOOSTRESIST", StatEnum.MAGIC_SKILL_BOOST_RESIST), MAXDP("MAXDP", StatEnum.MAXDP), MAXHAP("MAXHP", StatEnum.MAXHP), MAXHP("MAXMP",
				StatEnum.MAXMP), MP("MP", StatEnum.MAXMP), MPREGEN("MPREGEN", StatEnum.REGEN_MP), OPENAREIAL_ARP("OPENAREIAL ARP",
				StatEnum.OPENAREIAL_RESISTANCE_PENETRATION), PARALYZE_ARP("PARALYZE ARP", StatEnum.PARALYZE_RESISTANCE_PENETRATION), PARRY("PARRY",
				StatEnum.PARRY), PERIFICATION_ARP("PERIFICATION ARP", StatEnum.PERIFICATION_RESISTANCE_PENETRATION), PHYSICALCRITICALDAMAGEREDUCE(
				"PHYSICALCRITICALDAMAGEREDUCE", StatEnum.PHYSICAL_CRITICAL_DAMAGE_REDUCE), PHYSICALCRITICALREDUCERATE("PHYSICALCRITICALREDUCERATE",
				StatEnum.PHYSICAL_CRITICAL_RESIST), PHYSICALDEFEND("PHYSICALDEFEND", StatEnum.PHYSICAL_DEFENSE), POISON_ARP("POISON ARP",
				StatEnum.POISON_RESISTANCE_PENETRATION), ROOT_ARP("ROOT ARP", StatEnum.ROOT_RESISTANCE_PENETRATION), SILENCE_ARP("SILENCE ARP",
				StatEnum.SILENCE_RESISTANCE_PENETRATION), SLEEP_ARP("SLEEP ARP", StatEnum.SLEEP_RESISTANCE_PENETRATION), SLOW_ARP("SLOW ARP",
				StatEnum.SLOW_RESISTANCE_PENETRATION), SNARE_ARP("SNARE ARP", StatEnum.SNARE_RESISTANCE_PENETRATION), SPEED("SPEED", StatEnum.SPEED), SPIN_ARP(
				"SPIN ARP", StatEnum.SPIN_RESISTANCE_PENETRATION), STAGGER_ARP("STAGGER ARP", StatEnum.STAGGER_RESISTANCE_PENETRATION), STR("STR",
				StatEnum.POWER), STRVIT("STRVIT", StatEnum.STRVIT), STUMBLE_ARP("STUMBLE ARP", StatEnum.STUMBLE_RESISTANCE_PENETRATION), STUN_ARP("STUN ARP",
				StatEnum.STUN_RESISTANCE_PENETRATION), VIT("VIT", StatEnum.HEALTH), WIL("WIL", StatEnum.WILL);
		...
		public static AttrBonusAction getAttrBonusAction(String value) throws IllegalArgumentException {
