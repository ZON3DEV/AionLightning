 ...
 * Each desire should implement {@link #handleDesire(org.openaion.gameserver.ai.AI)} method with default behaviour.<br>
 * AI can override {@link org.openaion.gameserver.ai.AI#handleDesire(Desire)} to implement custom behaviour of desire.<br>
 * 
 * @author SoulKeeper
 * @modified ATracer
 * @see org.openaion.gameserver.ai.AI
 * @see org.openaion.gameserver.ai.AI#handleDesire(Desire)
...
public interface Desire extends Comparable<Desire>
{
	 ...
	 * {@link org.openaion.gameserver.ai.desires.DesireQueue#addDesire(Desire)} passing this instance as argument</b>
	 * 
	 * @param desirePower
